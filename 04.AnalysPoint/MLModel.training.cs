...
namespace _04_AnalysPoint
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\Admin\Documents\GitHub\Machine-Learning-Model-ML.NET\03. NET CORE 2.0\bin\Debug\netstandard2.0\data.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"col0", @"col0"),new InputOutputColumnPair(@"col1", @"col1")})      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.1,LabelColumnName=@"col2",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col2"))      
